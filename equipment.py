...
@dataclass
class EquipmentData:
    # TODO contains two lists with weapon and armor
    weapons: list[Weapon]
    armors: list[Armor]
...
class Equipment:
    ...
    def get_weapon(self, weapon_name) -> Optional[Weapon]:
        #TODO Returns object weapon by name
    ...
    def get_armor(self, armor_name) -> Optional[Armor]:
        #TODO Returns object armor by name
